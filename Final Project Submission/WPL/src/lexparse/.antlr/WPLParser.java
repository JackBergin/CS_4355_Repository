...
public class WPLParser extends Parser {
	...
	public static class ScalarContext extends ParserRuleContext {
		public Token id;
		public VarInitializerContext varInit;
	...
	public final ScalarContext scalar() throws RecognitionException {
		...
		try {
			...
			if (_la==ASSIGN) {
				{
				setState(92);
				((ScalarContext)_localctx).varInit = varInitializer();
				}
			}
	...
	public static class ProcedureContext extends ParserRuleContext {
		public ProcHeaderContext procH;
		public BlockContext blc;
	...
	public final ProcedureContext procedure() throws RecognitionException {
		...
		try {
			...
			{
			setState(114);
			((ProcedureContext)_localctx).procH = procHeader();
			setState(115);
			((ProcedureContext)_localctx).blc = block();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class FunctionContext extends ParserRuleContext {
		public FuncHeaderContext funcH;
		public BlockContext blc;
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			{
			setState(142);
			((FunctionContext)_localctx).funcH = funcHeader();
			setState(143);
			((FunctionContext)_localctx).blc = block();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LoopContext loop() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(204);
			((LoopContext)_localctx).blc = block();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class ConditionalContext extends ParserRuleContext {
		public ExprContext e;
		public BlockContext validBlock;
		public BlockContext invalidBlock;
	...
	public final ConditionalContext conditional() throws RecognitionException {
		...
		try {
			...
			setState(211);
			((ConditionalContext)_localctx).validBlock = block();
			setState(214);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==ELSE) {
				...
				match(ELSE);
				setState(213);
				((ConditionalContext)_localctx).invalidBlock = block();
				}
			}
